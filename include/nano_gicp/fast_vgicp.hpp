...
#include <nano_gicp/fast_vgicp_voxel.hpp>
...
class FastVGICP : public NanoGICP<PointSource, PointTarget> {
public:
  using Scalar = float;
...
protected:
  ...
  using NanoGICP<PointSource, PointTarget>::num_threads_;
  using NanoGICP<PointSource, PointTarget>::source_kdtree_;
  using NanoGICP<PointSource, PointTarget>::target_kdtree_;
  using NanoGICP<PointSource, PointTarget>::source_covs_;
  using NanoGICP<PointSource, PointTarget>::target_covs_;
